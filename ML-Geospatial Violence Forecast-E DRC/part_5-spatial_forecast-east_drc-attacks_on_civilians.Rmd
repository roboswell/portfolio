...
```{r ROC Curve and AUC Score, cache=TRUE, cache.lazy=FALSE, fig.height=6, fig.width=6, eval=FALSE, echo=TRUE}
...
# Plot ROC curve
plot(roc_obj, main = "ROC Curve (AUC = 0.877)", cex.main = 0.8, "cex.lab" = 0.8)

```

<br>

```{r ROC Curve and AUC Score - Plot, cache=TRUE, cache.lazy=FALSE, fig.height=6, fig.width=6, eval=TRUE, echo=FALSE, out.width="100%", fig.align='center'}
...
```{r Precision-Recall Curve and Area Under the Precision-Recall Curve Scores, cache=TRUE, cache.lazy=FALSE, fig.height=10, fig.width=10, eval=FALSE, echo=TRUE}
...
```{r Precision-Recall Curve and Area Under the Precision-Recall Curve Scores - Plot, cache=TRUE, cache.lazy=FALSE, fig.height=6, fig.width=6, eval=TRUE, echo=FALSE, out.width="100%", fig.align='center'}
