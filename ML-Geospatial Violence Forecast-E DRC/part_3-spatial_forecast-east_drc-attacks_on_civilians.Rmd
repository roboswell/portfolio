...
```{r Local Morans I Cluster Analysis, cache=TRUE, cache.lazy=FALSE, fig.height=30, fig.width=11.25, eval=FALSE, echo=TRUE}
...
png("local_morans_i_exploratory_analysis-idw_queens.png", width = 800, height = 800 / (11.25/28)) # Adjust the height by the aspect ratio. Set aspect ratio as 11.25 inch width and 28 inch height
...
```{r Local Morans I Cluster Analysis - Queens Matrix, cache=TRUE, cache.lazy=FALSE, fig.height=30, fig.width=11.25, eval=FALSE, echo=TRUE}
...
# Save the grid.arrange plot as a PNG file
png("local_morans_i_exploratory_analysis-standard_queens.png", width = 800, height = 800 / (11.25/28)) # Adjust the height by the aspect ratio. Set aspect ratio as 11.25 inch width and 28 inch height
