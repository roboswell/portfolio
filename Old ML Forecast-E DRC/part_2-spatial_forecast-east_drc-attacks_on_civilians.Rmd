...
# e_drc_adm3_map <- readRDS("e_drc_adm3_map.rds")
# 
# e_drc_adm3_map_centroids <- readRDS("e_drc_adm3_map_centroids.rds")
# 
# # Plotting the map with label repelling
# g_plot_2 <- ggplot() +
#   geom_sf(data = fishnet) +
...
```{r Map of Attacks on Civilians (2018-2023) - Plot, cache=TRUE, cache.lazy=FALSE, fig.height=10.5, fig.width=10.5, eval=TRUE, echo=FALSE, out.width="100%", fig.align='center'}

# Note: Uncomment out the following code to generate the image below

# attacks <- readRDS("acled_attacks.rds")
# 
# g_plot_3 <- ggplot() + 
#   geom_sf(data=fishnet) + 
#   geom_sf(data=e_drc_adm3_map, fill=NA, color = "white", linewidth = 0.3) +
...
#   theme(plot.title = element_text(face = "bold"))
# 
# ggsave("Attacks on Civilians, 2018-2023.png", plot = g_plot_3, width = 10.5, height = 10.5, units = "in")

knitr::include_graphics("Attacks on Civilians, 2018-2023.png")
