...
- GIS & Spatial Analysis:
    - **Title:** ["Predicting Attacks on Civilians in the Eastern Democratic Republic of Congo"](./ML-Geospatial%20Violence%20Forecast-E%20DRC/part_1-spatial_forecast-east_drc-attacks_on_civilians.html)
        ...
        - Technology Used: R, QGIS, mlr3, spatially aware cross-validation, XGBoost, Random Forest, Support Vector Machines, PCA, multi-objective tuning, hyperband, nsga2R, sf, raster, terra, spdep, blockCV, ggplot2, rayshader, pROC, PRROC, caret, data.tables
