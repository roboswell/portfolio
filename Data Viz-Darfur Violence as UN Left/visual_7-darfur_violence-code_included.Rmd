...
```{R Code for Visual 7 Maps, echo=TRUE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
acled_2021 <- st_read("acled_2021.shp", quiet = TRUE)
...
acled_2017 <- st_read("acled_2017.shp", quiet = TRUE)
...
darfur_base_coordinates_2016<-st_read("active_bases_2016.shp", quiet = TRUE)
...
```{R Combined 8 Maps, echo=TRUE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
