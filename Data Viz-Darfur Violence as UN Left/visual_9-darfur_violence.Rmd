...
```{R Perpetrators Share of Civilian Killings in South and West Darfur, message=FALSE, warning=FALSE, echo=FALSE}
...
```{R Perpetrators Number of Civilian Killings in South and West Darfur, message=FALSE, warning=FALSE, echo=FALSE}
...
```{R Creating sf Objects and Conducting Spatial Joins, message=FALSE, warning=FALSE, echo=FALSE}
...
```{R Code for 2017 Buffer on Map Calculations of Attacks on Civilians and Fatalities in South Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code for 2018 Buffer on Map Calculations of Attacks on Civilians and Fatalities in South Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code for 2019 Buffer on Map Calculations of Attacks on Civilians and Fatalities in South Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code for 2017 Buffer on Map Calculations of Attacks on Civilians and Fatalities in West Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code for 2018 Buffer on Map Calculations of Attacks on Civilians and Fatalities in West Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code for 2019 Buffer on Map Calculations of Attacks on Civilians and Fatalities in West Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code - Combine Dataframes, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code - Create Identity Militia Killings Table for South Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code - Create Identity Militia Killings Table for West Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
#### In the next 2 tables, I will examine all civilian killings committed by all identity militias in the years and inside the union buffers found to be especially deadly in the prior 2 tables: South Darfur in 2020 and 2021 within 50 mi of the UN bases withdrawn from South Darfur in 2018, and West Darfur in 2019 and 2021 within 50 mi of the UN bases withdrawn from West Darfur in 2018.


```{R Code - Calculate 2018 Union Buffer Areas as a Percentage of Total S and W Darfur Areas, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code - Create Chart Showing 2020 Numbers of ALL Identity Militia Killings inside 50 Mi Radius Union Buffer for UN Bases Closed in 2018 in South Darfur  , echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
...
```{R Code - Create Chart Showing 2019 & 2021 Numbers of ALL Identity Militia Killings inside 50 Mi Radius Union Buffer for UN Bases Closed in 2018 in West Darfur, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
