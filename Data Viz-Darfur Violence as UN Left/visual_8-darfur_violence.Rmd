...
active_bases_2016_joined = readOGR(dsn = paste0(getwd()), layer="active_bases_2016_joined")
...
active_bases_2018_joined<-st_read("active_bases_2018_joined.shp")
CRS.new <- st_crs("EPSG:4269")
...
active_bases_2019_joined<-st_read("active_bases_2019_joined.shp")
CRS.new <- st_crs("EPSG:4269")
...
closed_bases_south_2017 = readOGR(dsn = paste0(getwd()), layer="closed_bases_south_2017-portfolio_2023")
...
closed_bases_south_2018 = readOGR(dsn = paste0(getwd()), layer="closed_bases_south_2018-portfolio_2023")
...
acled_2020 = readOGR(dsn = paste0(getwd()), layer="acled_2019")
CRS.new <- st_crs("EPSG:4087")
...
```{R Joined 6 Maps, echo=FALSE, fig.height=18, fig.width=10, message=FALSE, warning=FALSE}
